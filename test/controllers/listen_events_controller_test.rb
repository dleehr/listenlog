...
class ListenEventsControllerTest < ActionController::TestCase
  ...
  test "should create listen_event" do
    assert_difference('ListenEvent.count') do
      post :create, listen_event: { equipment: @listen_event.equipment, finished: @listen_event.finished, started: @listen_event.started, title: @listen_event.title }
    end
  ...
  test "should update listen_event" do
    patch :update, id: @listen_event, listen_event: { equipment: @listen_event.equipment, finished: @listen_event.finished, started: @listen_event.started, title: @listen_event.title }
    assert_redirected_to listen_event_path(assigns(:listen_event))
  end
